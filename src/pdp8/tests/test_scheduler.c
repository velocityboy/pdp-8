...
DECLARE_TEST(sch_scheduler_delete, "priority queue scheduler: delete") {
    scheduler_t *sch = scheduler_create();
    ...
    scheduler_delete(sch, &fn4, (void*)4);
    ...
    scheduler_delete(sch, &fn4, (void*)4);
    scheduler_delete(sch, &fn1, (void*)1);
    scheduler_delete(sch, &fn5, (void*)5);
    scheduler_delete(sch, &fn2, (void*)2);
